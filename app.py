...
st.set_page_config(page_title="Anna Garcia's News Articles", layout="centered")
...
if st.session_state.current_page == "Home":
    st.subheader("Anna Garcia's News Articles")
    st.markdown("---")
    for x in range(0, 10):
    ...
    st.write(dataframed["UST"][st.session_state.story_index])
    st.markdown("---")
